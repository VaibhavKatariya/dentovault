...
export default function PatientDetail() {
  ...
  return (
    <div className="p-6 sm:p-10 max-w-7xl">
      <Link to="/patients" className="inline-flex items-center gap-2 label-mono mb-6 hover:text-foreground">
        ...
        <div className="flex gap-2">
          ...
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button variant="outline" size="icon" data-testid="delete-patient-button">
          ...
          {current && (
            <>
              ...
              <div className="hidden md:flex border-l border-border p-5 flex-col">
                ...
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <Button variant="outline" size="sm" className="gap-2 mt-4 w-full" data-testid="delete-image-button">
