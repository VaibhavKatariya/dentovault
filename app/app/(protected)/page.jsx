...
export default function Dashboard() {
  ...
  const cards = [
    ...
    {
      label: "Storage Used",
      value: stats ? fmtBytes(stats.total_storage_bytes) : "—",
      icon: HardDrive,
      testid: "stat-storage",
    },
    {
    ...
    <div className="p-6 sm:p-10 max-w-7xl">
      <div className="flex items-end justify-between mb-10">
        <div>
          ...
          <h1 className="font-display text-4xl sm:text-5xl tracking-tight font-light">
            Dashboard
          </h1>
        </div>
        ...
        <Link href="/patients">
          <Button
            variant="outline"
            size="sm"
            data-testid="goto-patients-button"
            className="gap-2"
          >
            All Patients
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-border border border-border mb-12">
        {cards.map((c) => (
          ...
          >
            ...
            <div className="font-display text-3xl sm:text-4xl font-light tracking-tight">
              {c.value}
            </div>
          </div>
        ))}
